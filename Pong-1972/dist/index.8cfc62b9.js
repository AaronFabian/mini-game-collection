...
function animate() {
    ...
    if (runEngine) {
        if (isSmartPhone) {
            if ((0, _utils.getDistCirRec)(ball[0], player) || player.height + ball[0].radius < ball[0].radius) ball[0].dy = -ball[0].dy;
            if ((0, _utils.getDistCirRec)(ball[0], playerTwo) || player.height + ball[0].radius < ball[0].radius) ball[0].dy = -ball[0].dy;
        } else {
            if ((0, _utils.getDistCirRec)(ball[0], player)) ball[0].dx = -ball[0].dx;
            if ((0, _utils.getDistCirRec)(ball[0], playerTwo)) ball[0].dx = -ball[0].dx;
        }
        player.update();
        playerTwo.update();
...
},{}]},["2mNKm","6rimH"], "6rimH", "parcelRequire7ed1")
